<div class="container home-page">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-4">
            <div class="card">
                <h2>Empréstimos</h2>
                <p>Obtenha o financiamento necessário para alcançar seus objetivos.</p>
                <a href="http://<?php echo APP_HOST; ?>/info/emprestimos.php" class="btn btn-secondary">Saiba mais</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <h2>Investimentos</h2>
                <p>Faça seu dinheiro crescer com nossas opções de investimento.</p>
                <a href="http://<?php echo APP_HOST; ?>/info/investimentos.php" class="btn btn-secondary">Explore</a>
            </div>
        </div>
    </div>
</div>